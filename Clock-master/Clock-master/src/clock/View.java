...
public class View implements Observer, ActionListener, ItemListener {
    ...
    public View(Model model) {
        ...
        menuItemV2 = new JMenuItem(new ButtonActionv4());
    ...
    protected class ButtonActionv4 extends AbstractAction {
        public ButtonActionv4() {
        super ("Add Queue to Calendar");
                }
        //@Override
        @Override
        public void actionPerformed(ActionEvent r)  {
                iCalMaker a = new iCalMaker();
            a.write("Alarm List");
