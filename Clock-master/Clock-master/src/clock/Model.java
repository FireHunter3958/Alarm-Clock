...
public class Model extends Observable {
    ...
    /**
     * This method is responsible for limiting the user inputs
     * @return 
     */
    /*
    ...
    public void update() {
        ...
        //for (int i = 0; i < viewArray.length; i++) {
            ...
            final JTextField fieldValue = new JTextField("Your alarm is going off!");
                ...
                //int removeObject = (int) alarmArray[0];
...
/*
    ...
    /**
     *This method is responsible for retrieving an external file, and retrieving the stored alarm values.
     * Due to the file being in an iCal format, the majority of the file must be skipped.
     * @param file is the variable provided by the method that calls this method. It is the value of the file name that will be loaded.
     * @return alarmQueue this returns the value of alarmQueue, after inserting the loaded values into the queue.
     ...
     * Due to the file being in an iCal format, the majority of the file must be skipped.
     * @param file is the variable provided by the method that calls this method. It is the value of the file name that will be loaded.
     * @return alarmView this returns the value of alarmView, after inserting the loaded values into the queue.
     * @throws FileNotFoundException
     * @throws IOException
     */
    ...
    /**
     *This method is responsible for saving the current queue on program close.
     * @param file
     * @param file2
     */
        /*
